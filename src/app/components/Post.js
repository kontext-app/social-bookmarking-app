    ...
    return (
      <div className="px-16 flex border border-grey-light-alt hover:border-grey rounded bg-white hover:bg-gray-100 cursor-pointer">
        ...
        <div className="w-11/12 pt-2 text-left">
          ...
          <div>
            <h2 className="font-medium mb-1">{this.props.post.message.commentHeader ? this.props.post.message.commentHeader : "unknown"}</h2>
          </div>
          <div>
            {/*<p className="font-normal mb-3 text-sm">{this.props.post.message.comment ? this.props.post.message.comment : "unknown"}</p>*/}
            <p className="font-normal mb-3 text-sm text-blue-500">#crypto #coding #design</p>
          </div>
          <div className="flex inline-flex items-center my-1">
            ...
            <div className="flex hover:bg-grey-lighter p-1 ml-2 rotate-90">
              <svg className="w-3 fill-current text-grey" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 12a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0-6a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 12a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"/></svg>
            </div>
          </div>
        </div>
      </div>
