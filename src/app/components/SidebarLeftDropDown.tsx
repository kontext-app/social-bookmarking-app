...
export function SidebarLeftDropDown(): JSX.Element {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {isComponentVisible && (
        <div className="absolute right-0 w-full origin-top-right rounded-md shadow-lg px-2 py-2 bg-white shadow">
...
function DropDownItem(props: {
  ...
  const { linkTo = '', label = '', onClick } = props;
  return (
    <Link to={linkTo} onClick={onClick}>
      <div className="flex space-x-2 items-center px-4 py-2 text-sm font-semibold rounded-lg mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
        <svg
          width="18"
          height="18"
