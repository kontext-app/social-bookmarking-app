...
export function SidebarLeft() {
  return (
    <div className="md:flex flex-col md:flex-row md:min-h-screen">
      <div
        /*@click.away="open = false"*/ className="flex flex-col w-full md:w-64 text-gray-700 bg-gray-100 dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0"
        x-data="{ open: false }"
      >
        ...
        <nav
          /*:className="{'block': open, 'hidden': !open}"*/ className="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto"
        >
          <div
            /*@click.away="open = false"*/ className="dropdown relative"
            x-data="{ open: false }"
          >
            <Link to="/profile">
              <button
                /*@click="open = !open"*/ className="flex space-x-2 w-full items-center block px-4 py-2 text-sm font-semibold text-gray-900 rounded-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
              >
                ...
                <svg
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  /*:className="{'rotate-180': open, 'rotate-0': !open}"*/ className="inline w-4 h-4 mt-1 ml-1 transition-transform duration-200 transform md:-mt-1"
                >
                  <path
                    fill-rule="evenodd"
            ...
            <div className="dropdown-menu hidden absolute right-0 w-full origin-top-right rounded-md shadow-lg">
              <div className="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
                <Link to="/profile">
                  <a
                    className="flex space-x-2 items-center block px-4 py-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                    href="#"
                  >
                    <svg
                      width="18"
          ...
          <a
            className="flex justify-between space-x-2 items-center block px-4 py-2 text-sm rounded-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
            href="#"
          >
